            ...
            >
              ...
              <div className="space-y-4">
                ...
                <a
                  ...
                  className="flex min-w-0 items-start gap-4 p-4 bg-[--bg-color] rounded-lg border border-[--light-border] hover:border-[--prim-color] transition-all group"
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="whitespace-nowrap text-[clamp(0.65rem,2.5vw,0.875rem)] text-[--text-light]">joanjudithpelesi@gmail.com</p>
                  </div>
                </a>
